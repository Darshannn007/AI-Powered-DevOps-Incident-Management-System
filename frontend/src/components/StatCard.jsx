...
export default function StatCard({ title, value, change = '+5%', icon: Icon, color = 'emerald' }) {
  const colorStyles = {
  ...
  return (
    <div className="bg-white rounded-3xl p-6 shadow-card border border-gray-100/80 flex flex-col justify-between">
      <div className="flex items-center justify-between">
        ...
        {Icon && (
          <div className={`w-9 h-9 rounded-2xl flex items-center justify-center border ${colorStyles[color] || colorStyles.emerald}`}>
